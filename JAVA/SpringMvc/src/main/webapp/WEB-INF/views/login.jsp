...
<%-- 	<%
		...
		if (errorString != null && errorString.trim().equals("true")) {
			out.println("<h3 class=\"errorblock\">Incorrect login name or password. Please try again");
		}
	%> --%>
...
<%-- 	<c:set var="errorString" value = "${error}"/> --%>
	<c:if test = "${error != null && error.trim().equals(\"true\")}">
		<h3 class="errorblock">Incorrect login name or password. Please try again</h3>
	</c:if>
